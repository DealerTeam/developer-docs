...
## Constructors
### `public SalesUpDuplicateSearchLex_EXT(ApexPages c)`
---
## Fields
...
**Notes** based on the users preferences this method is called on page load to direct the user user to the right location.
...
|Type|Description|
|---|---|
|`PageReference`|PageReference to SalesUpDuplicateSearchLex.page|
...
### `public PageReference attachAccountToSalesUp()`
### `public PageReference performSearch()`
### `public PageReference createSalesUp()`
